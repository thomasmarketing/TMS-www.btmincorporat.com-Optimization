	...
	<div class="top-line">
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-8 col-sm-6 col-xs-6 col-7">
					<?php
					$tel_number = get_field('global_phone_number','option');
					$unformatted_tel_number = preg_replace("/[^0-9]/", '', $tel_number);?>
					<?php if ($tel_number): ?>
						<span class="sh-ph"><a class="cms_phone" href="tel:<?php echo $unformatted_tel_number;?>" aria-label="Call Us" title="Call Us"><span class="material-icons">call</span> <span class="top-menu-num"><?php echo $tel_number;?></span></a></span>
					<?php endif ?>
...
<span class="sh-search mx-md-3"><a href="#search" class="search-form-tigger" data-toggle="search-form" aria-label="Search">Search<span class="material-icons">search</span></a></span>
				</div>
			</div>
		</div>
	</div>
		...
		<nav class="navbar navbar-expand-lg navbar-light">
			<div class="container">
						...
						<div class="utility-nav navbar-right">
					        ...
					        $email_address = get_field('global_email', 'option');
					        if ($email_address): ?>
					            <span class="sh-email d-md-none m-0"><a class="cms_email" href="mailto:<?php echo strtolower($email_address); ?>" title="Email Us" aria-label="Email Us"><span class="material-icons">mail_outline</span> <span class="top-menu-email"><?php echo $email_address; ?></span></a></span>
					        <?php endif ?>
