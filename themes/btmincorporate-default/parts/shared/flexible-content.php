...
<?php if( have_rows('flexible_content') ): $i = 0; echo '<section class="additional-content">';
		...
		<section class="accordian-tabs-module" id="accordian-tabs-module-<?php echo $i ?>">
		 	<div class="container <?php echo !empty(get_sub_field('container_padding')) ? get_sub_field('container_padding') : 'py-5' ?>">	
				...
				<ul class="accordion-tabs">
					...
					<li class="tab-header-and-content"><a href="javascript:void(0)" class="tab-link"><?php echo get_sub_field('tab_header'); ?></a><div class="tab-content">
						<?php echo get_sub_field('tab_body'); ?></div></li>
	...
	<?php elseif( get_row_layout() == 'full_width_cta1' ): ?>
		<section class="fullwidth-cta1 <?php if (get_sub_field('cvp2_para_img')): ?> fixed-bg<?php endif ?>" id="fullwidth-cta1<?php echo $i ?>" <?php if (get_sub_field('fwc_bg')): ?>style="background-image: url(<?php echo get_sub_field('fwc_bg'); ?>);"<?php endif ?>>
			 <div class="container">
				<div class="fullwidth-cta1-wrap wow fadeInLeft">
				...
				if( $link ): 
				    ...
				    $link_target = $link['target'] ? $link['target'] : '_self';
				    ?>
				    <a class="button btn  btn-secondary btn-lg fwc-cta1" href="<?php echo esc_url( $link_url ); ?>" target="<?php echo esc_attr( $link_target ); ?>"><?php echo esc_html( $link_title ); ?></a>
				<?php endif; ?>
			...
			<div class="fullwidth-cta1-overlay"> </div>
		</section>
			 ...
			 <div class="container">
			 	<div class="fwc2-wrap">
					...
					if( $link ): 
					    ...
					    $link_target = $link['target'] ? $link['target'] : '_self';
					    ?>
					    <span><a class="button btn btn-outline-light btn-lg fwc-cta1" href="<?php echo esc_url( $link_url ); ?>" target="<?php echo esc_attr( $link_target ); ?>"><?php echo esc_html( $link_title ); ?></a></span>
					<?php endif; ?>
			 	</div>
			 </div>
		</section>
		...
		<section class="item-listing-on-bg-module text-center <?php if (get_sub_field('cvp2_para_img')): ?> fixed-bg<?php endif ?>" id="item_listing_on_bg_module<?php echo $i ?>" <?php if (get_sub_field('ilb_bg')): ?>style="background-image: url(<?php echo get_sub_field('ilb_bg'); ?>)"<?php endif ?>>
			<div class="container <?php echo !empty(get_sub_field('container_padding')) ? get_sub_field('container_padding') : 'py-5' ?>">
				<?php if (get_sub_field('ilb_heading')): ?>
					<h2 class="ilb-heading wow fadeInleft"><?php echo get_sub_field('ilb_heading'); ?></h2>
				<?php endif ?>
				<?php if (get_sub_field('ilb_description')): ?>
					<p class="ilb-description wow fadeInRight"><?php echo get_sub_field('ilb_description'); ?></p>
				<?php endif ?>

				<?php if (have_rows('lib_items')): ?>
				<div class="ilb-listing">
					<?php while (have_rows('lib_items')): the_row(); ?>
					<?php $animation = get_sub_field('animation_style') != 'none' ? get_sub_field('animation_style') . ' animated' : ''; ?>	
					<div class="col-12 col-sm-6 col-md-4 col-lg-4 col-xl-2 ilb-item wow fadeInUp <?php echo $animation; ?>">
						<div class="img-wrap">
						<?php
				...
				if( $link ): 
				    ...
				    $link_target = $link['target'] ? $link['target'] : '_self';
				    ?>
					<a class="btn icgm-cta btn-lg" href="<?php echo esc_url( $link_url ); ?>" target="<?php echo esc_attr( $link_target ); ?>"><?php echo esc_html( $link_title ); ?></a>
				<?php endif; ?>
			</div>
		</section>
		...
		<section class="video-content-grid-module <?php if( get_sub_field('module_showhide')): ?>d-none<?php endif; ?>">
			<div class="container <?php echo !empty(get_sub_field('container_padding')) ? get_sub_field('container_padding') : 'py-5' ?>">
				<div class="vcgm-top-content">
					...
					<div class="vcgmtc-right-content wow fadeInRight">
						<?php if (get_sub_field('vcgm_head_description')): ?><?php echo get_sub_field('vcgm_head_description') ?><?php endif ?>
					</div>
				</div>
				...
				<div class="row vcgm-wrap">
					...
					<?php $animation = get_sub_field('animation_style') != 'none' ? get_sub_field('animation_style') . ' animated' : ''; ?>	
					<div class="<?php echo $gridClass; ?> vcgm-item wow fadeInUp <?php echo $animation; ?>">
						<?php 
						...
						<?php if (get_sub_field('vcgm_heading')): ?>
							<div class="vcgm-heading"><?php echo get_sub_field('vcgm_heading') ?></div>
						<?php endif ?>
				...
				<?php endif ?>
				<?php 
							$link = get_sub_field('vcgm_button');
							if( $link ): 
							    $link_url = $link['url'];
							    $link_title = $link['title'];
							    $link_target = $link['target'] ? $link['target'] : '_self';
							    ?>
								<div class="vcgm-cta-wrap">
...
<section class="image-content-grid-module">
            ...
            <div class="container">
                ...
                <div class="row icgm-wrap">
					...
					<a class="icgm-link" href="<?php echo esc_url( $link_url ); ?>" target="<?php echo esc_attr( $link_target ); ?>">
						<?php 
						$image = get_sub_field('icgm_img');
						if( !empty( $image ) ): ?>
						<img class="wow fadeInDown" src="<?php echo esc_url($image['url']); ?>" alt="<?php echo esc_attr($image['alt']); ?>" title="<?php echo esc_attr($image['alt']); ?>" />
						<?php endif; ?>
						<span class="icgm-bottom-wrapper wow fadeInUp">
							<span>
								<span class="icgm-bw-text">
									<?php if (get_sub_field('icgm_heading')): ?>
										<h3 class="icgm-heading"><?php echo get_sub_field('icgm_heading') ?></h3>
									<?php endif ?>
								...
								<span class="icgm-bw-img">
									<?php 
									$image = get_sub_field('icgm_icon');
									if( !empty( $image ) ): ?>
	...
	<section class="fullwidth-cta2" <?php if (get_sub_field('fwc_bg')): ?>style="background-image: url(<?php echo get_sub_field('fwc_bg'); ?>);"<?php endif ?>>
		 <div class="container">
			<div class="fwc2-section-wrapper">
		 	<div class="fwc2-wrap">
		 		<?php if (get_sub_field('fwc_heading')): ?>
		    		<h2 class="fwc2-heading wow fadeInleft"><?php echo get_sub_field('fwc_heading'); ?></h2>
		    	<?php endif ?>
		    	<?php 
				$link = get_sub_field('fwc_cta1');
				if( $link ): 
				    ...
				    $link_target = $link['target'] ? $link['target'] : '_self';
				    ?>
				    <span class="wow fadeInRight"><a class="button btn  btn-primary btn-lg fwc-cta1" href="<?php echo esc_url( $link_url ); ?>" target="<?php echo esc_attr( $link_target ); ?>"><?php echo esc_html( $link_title ); ?></a></span>
				<?php endif; ?>
		 	</div>
		   </div>
		 </div>
