...
<section class="fullwidth-cta1 <?php if (get_field('cvp2_para_img','option')): ?> fixed-bg<?php endif ?>" id="fullwidth-cta1" <?php if (get_field('fwc_bg','option')): ?>style="background-image: url(<?php echo get_field('fwc_bg','option'); ?>);"<?php endif ?>>
			 <div class="container">
