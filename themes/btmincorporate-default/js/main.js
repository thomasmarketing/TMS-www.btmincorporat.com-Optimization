...
$(document).on('ready', function() {
  ...
  $('.si-slider .slick-dots').wrapAll('<div class="si-pgintions-dots"></div>');
  $('.si-slider .slick-prev').wrapAll('<div class="si-pgintions-arrows"></div>');
  $('.si-slider .slick-next').insertAfter('.si-slider .slick-prev');
  $('.si-pgintions-dots, .si-pgintions-arrows').wrapAll('<div class="si-pgintions"></div>');
});
